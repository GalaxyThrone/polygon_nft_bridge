...
contract openAccessNFTBridge is Ownable, IERC721Receiver {
    ...
    function claimBridged(
        ...
        bytes32[2] memory smtProof  = [bytes32(0x048a645062893f9153da1ffefbf9edbfdd373fecf764fbe41e77a50d00000001), bytes32(0x048a645062893f9153da1ffefbf9edbfdd373fecf764fbe41e77a50d00000001)];
uint32 index = 42; // the index of the Merkle proof to use
bytes32 mainnetExitRoot = bytes32(0x049a645062893f9153da1ffefbf9edbfdd373fecf764fbe41e77a50d00000001); // a 32-byte value representing the Merkle root of the mainnet exit tree
bytes32 rollupExitRoot = bytes32(0x048a645062893f9153da1ffefbf9edbfdd373fecf764fbe41e77a50d00000001); // a 32-byte value representing the Merkle root of the rollup exit tree
...
bytes memory metadataBytes = bytes(metadataString);
        polygonBridge.claimMessage(
          smtProof,index,mainnetExitRoot,rollupExitRoot,originNetwork,originAddress,destinationNetwork, destinationAddress,amount,metadataBytes
        );
    ...
    uint public totalRequestsSent;
      ...
      IPolygonBridgeContract bridge = IPolygonBridgeContract(0xF6BEEeBB578e214CA9E23B0e9683454Ff88Ed2A7);
